...
```
Edit `data/canonical-facts/<domain>.csv` or observation value
...
| `data/canonical-facts/<domain>.csv` | Source of facts — one file per domain (people, healthcare, education, etc.) |
