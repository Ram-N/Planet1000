...
data/generated/puzzles/*.json    ← full puzzle JSONs
lib/puzzle-loader.ts             ← regenerated automatically (imports + registry)
        │
        ▼
game page
```
...
| `lib/puzzle-loader.ts` | Regenerated by `build:puzzles` — do not edit by hand |
